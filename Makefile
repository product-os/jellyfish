...
# Balena API
INTEGRATION_BALENA_API_TOKEN ?=
export INTEGRATION_BALENA_API_TOKEN
INTEGRATION_BALENA_API_SIGNATURE_KEY ?=
export INTEGRATION_BALENA_API_SIGNATURE_KEY
...
TEST_INTEGRATION_FRONT_INBOX_1 ?= inb_q3pu # Test Inbox
export TEST_INTEGRATION_FRONT_INBOX_1
TEST_INTEGRATION_FRONT_INBOX_2 ?= inb_oi16 # Inbox #1
