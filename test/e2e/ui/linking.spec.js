...
test('Can link and unlink contracts through modal', async ({ page }) => {
	...
	await page
		.locator('//div[contains(@class, "jellyfish-async-select__input")]/input')
		.fill(patternName);
	await page.waitForSelector(
		`//div[contains(@class, "jellyfish-async-select__option")]/div/div[text()="${patternName}"]`,
	);
