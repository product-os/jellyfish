...
ava('.isValidExternalEventRequest() should return false given GitHub and a signature mismatch', async (test) => {
	const result = sync.isValidExternalEventRequest(
		syncContext.getToken('github'), 'github', '{"foo":"bar"}', {
