...
module.exports = class Worker {
	...
	getActionContext (context) {
		return {
			...
			patchCard: _.bind(function (lsession, typeCard, options, card) {
				return this.patchCard(context, lsession, typeCard, options, card)
			}, this),
	 ...
	 * @returns {Object} inserted card
	 */
	// TODO: Take a JSON Patch array as input
	patchCard (context, insertSession, typeCard, options, card) {
		return runExecutor(this, context, insertSession, typeCard, card, {
			override: true,
			timestamp: options.timestamp,
			reason: options.reason,
