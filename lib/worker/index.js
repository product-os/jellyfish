...
module.exports = class Worker {
	...
	insertCard (context, insertSession, typeCard, options, card) {
		return runExecutor(executor.insertCard, this, context, insertSession, typeCard, card, {

			// TODO: This should not be necessary anymore once
			// all the clients upserting with .insertCard()
			// move to .patchCard().
