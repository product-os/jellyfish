...
module.exports = class FullTextSearchFilter extends SqlFilter {
	constructor (query, term, asArray = false) {
		super()

		const isRootArray = asArray && query.isProcessingColumn
		this.tsVector = textSearch.toTSVector(query.path[0], query.path.slice(1), isRootArray)
