...
exports.regexp = (value, path, walk, schema, context, keys) => {
	const selector = builder.getProperty(path, {
		text: true
	})
...
exports.formatMaximum = (value, path, walk, schema, context, keys) => {
	const postgresValue = builder.valueToPostgres(value)
	return {
		keys,
		filter: builder.or(
...
exports.formatMinimum = (value, path, walk, schema, context, keys) => {
	const postgresValue = builder.valueToPostgres(value)
	return {
		keys,
		filter: builder.or(
