...
exports.setup = async (context, connection, database) => {
	...
	await connection.any(`
		...
		ALTER TABLE ${LOCK_TABLE} ALTER timestamp TYPE TIMESTAMP WITH TIME ZONE USING timestamp::TIMESTAMP WITH TIME ZONE;
		`)
}
