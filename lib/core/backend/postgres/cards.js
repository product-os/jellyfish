...
exports.upsert = async (context, errors, connection, object, options) => {
	...
	const payload = [
		elementId,
		insertedObject.slug,
		insertedObject.type.includes('@')
			? insertedObject.type

			// Backfill versions in types if needed
			// TODO: Remove this after we completely migrate the database.
			// See https://github.com/balena-io/jellyfish/pull/2909
			: `${insertedObject.type}@1.0.0`,
