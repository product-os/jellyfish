...
exports.setup = async (context, connection, database, options = {}) => {
	...
	await connection.any(`
		...
		ALTER TABLE ${table} ALTER created_at TYPE TIMESTAMP WITH TIME ZONE USING created_at::TIMESTAMP WITH TIME ZONE;
		ALTER TABLE ${table} ALTER updated_at TYPE TIMESTAMP WITH TIME ZONE USING updated_at::TIMESTAMP WITH TIME ZONE;
		`)
