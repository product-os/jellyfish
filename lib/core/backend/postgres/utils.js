...
exports.convertDatesToISOString = (row) => {
	...
	const linkTypes = [
		'has_attached_element',
		'support_thread_is_attached_to_support_issue',
		'support_thread_is_attached_to_issue',
		'support_thread_is_attached_to_product_improvement',
		'is_member_of',
		'has_member',
		'is_executed_by',
		'is_attached_to'
	...
	for (const linkType of linkTypes) {
		_.forEach(row[`links.${linkType}`], exports.convertDatesToISOString)
	}
}
