...
module.exports = class Kernel {
   ...
   * await kernel.initialize()
	 *
	 * if (await kernel.lock(context, '4a962ad9-20b5-4dd8-a707-bf819593cc84', {
	 *   slug: 'foobar',
	 *   ...
	 * })) {
   ...
   * await kernel.initialize()
	 ...
	 *   console.log('Got the lock!')
	 *
	 *   if (await kernel.unlock(context, '4a962ad9-20b5-4dd8-a707-bf819593cc84', {
	 *     slug: 'foobar',
	 *     ...
	 *   })) {
	 *     console.log('Unlock!')
