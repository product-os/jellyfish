...
exports.filter = (() => {
	...
	return (schema, object, options = {}) => {
		...
		if (schema.anyOf && exports.isValid(schema, object)) {
			...
			for (const fragment of _.cloneDeep(schema.anyOf)) {
				const mergedFragment = _.mergeWith(
					{
						type: 'object'
					},
					fragment,
				...
				if (exports.isValid(mergedFragment, object)) {
					const fragmentSchema = disallowAdditionalProperties(mergedFragment, {
						force: options.force
					})
