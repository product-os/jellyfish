...
const newCompilerTestChance = Number(process.env.NEW_COMPILER_TEST_CHANCE)
exports.experimental = {
	newCompilerTestChance: newCompilerTestChance >= 0 && newCompilerTestChance <= 1 ? newCompilerTestChance : 0
}
