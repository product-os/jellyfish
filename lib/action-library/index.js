...
module.exports = {
	...
	'action-create-event': {
		...
		handler: async (session, context, card, request) => {
			...
			// TODO: Calculate this using formulas on the card type schema
			if (typeCard.slug === 'message' || typeCard.slug === 'whisper') {
				parseMarkdownFromCardData(data)
			}
