...
module.exports = {
	'action-integration-import-event': async (session, context, card, request) => {
		return sync.translate(syncContext(ctx, session, context), card, request)
	},
	'action-integration-github-mirror-event': async (session, context, card, request) => {
		return sync.mirror('github', syncContext(ctx, session, context), card, request)
	},
	'action-integration-front-mirror-event': async (session, context, card, request) => {
		return sync.mirror('front', syncContext(ctx, session, context), card, request)
	},
