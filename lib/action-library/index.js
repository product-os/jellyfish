...
module.exports = {
	'action-integration-import-event': async (session, context, card, request) => {
		return sync.translate(session, syncContext(session, context), card, request)
	},
	'action-integration-github-mirror-event': async (session, context, card, request) => {
		return sync.mirror('github', session, syncContext(session, context), card, request)
	},
	'action-integration-front-mirror-event': async (session, context, card, request) => {
		return sync.mirror('front', session, syncContext(session, context), card, request)
	},
