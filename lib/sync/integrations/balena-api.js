...
module.exports.OAUTH_BASE_URL = environment.integration['balena-api'].oauthBaseUrl
module.exports.OAUTH_SCOPES = []

module.exports.whoami = async (credentials, context, options, retries = 10) => {
	const {
		code: statusCode,
		body: data
