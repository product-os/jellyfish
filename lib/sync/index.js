 ...
 */
exports.whoami = async (context, integration, credentials) => {
	const Integration = context.OAUTH_INTEGRATIONS ? context.OAUTH_INTEGRATIONS[integration] : INTEGRATIONS[integration]
 ...
 * @returns {Object} external user
 */
exports.match = async (context, integration, externalUser, options) => {
	const Integration = context.OAUTH_INTEGRATIONS ? context.OAUTH_INTEGRATIONS[integration] : INTEGRATIONS[integration]
...
exports.getExternalUserSyncEventData = async (context, integration, externalUser) => {
	const Integration = context.OAUTH_INTEGRATIONS ? context.OAUTH_INTEGRATIONS[integration] : INTEGRATIONS[integration]
