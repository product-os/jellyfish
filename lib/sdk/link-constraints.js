...
exports.constraints = [
	...
	{
		slug: 'link-constraint-opportunity-has-primary-owner-user',
		name: 'has primary owner',
		data: {
			title: 'Primary owner',
			from: 'opportunity',
			to: 'user',
			inverse: 'link-constraint-user-is-primary-owner-of-opportunity'
		}
	},
	{
		slug: 'link-constraint-user-is-primary-owner-of-opportunity',
		name: 'is primary owner of',
		data: {
			title: 'Primary owner',
			from: 'user',
			to: 'opportunity',
			inverse: 'link-constraint-opportunity-has-primary-owner-user'
		}
	},
	{
		slug: 'link-constraint-opportunity-has-secondary-owner-user',
		name: 'has secondary owner',
		data: {
			title: 'secondary owner',
			from: 'opportunity',
			to: 'user',
			inverse: 'link-constraint-user-is-secondary-owner-of-opportunity'
		}
	},
	{
		slug: 'link-constraint-user-is-secondary-owner-of-opportunity',
		name: 'is secondary owner of',
		data: {
			title: 'secondary owner',
			from: 'user',
			to: 'opportunity',
			inverse: 'link-constraint-opportunity-has-secondary-owner-user'
		}
	},
	{
