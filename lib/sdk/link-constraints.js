...
exports.constraints = [
	...
	{
		slug: 'link-constraint-project-is-coordinated-by-user',
		name: 'is coordinated by',
		data: {
			title: 'Coordinator',
			from: 'project',
			to: 'user',
			inverse: 'link-constraint-user-coordinates-project'
		}
	},
	{
		slug: 'link-constraint-user-coordinates-project',
		name: 'coordinates',
		data: {
			title: 'Project',
			from: 'user',
			to: 'project',
			inverse: 'link-constraint-project-is-coordinated-by-user'
		}
	},
	{
	...
	{
		slug: 'link-constraint-project-has-advisor',
		name: 'has advisor',
		data: {
			title: 'Advisor',
			from: 'user',
			to: 'project',
			inverse: 'link-constraint-user-is-advisor-for-project'
		}
	},
	{
		slug: 'link-constraint-user-is-advisor-for-project',
		name: 'is advisor for',
		data: {
			title: 'Project',
			from: 'project',
			to: 'user',
			inverse: 'link-constraint-project-has-advisor'
		}
	},
	{
