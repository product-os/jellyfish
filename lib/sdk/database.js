...
module.exports = class Database {
  ...
  async initialize () {
    ...
    await this.insertCard(CARDS.TYPE.CARD, {
      override: true
    })

    await this.insertCard(CARDS.TYPE.USER, {
      override: true
    })

    await this.insertCard(CARDS.EVENT.CREATE, {
      override: true
    })
  }
  ...
  async insertCard (card, options = {}) {
    ...
    ensureObjectMatchesSchema(cardType.getSchema(CARDS.TYPE.CARD), card)
