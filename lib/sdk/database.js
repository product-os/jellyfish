...
const debug = require('debug')('jellyfish:database')
...
module.exports = class Database {
  ...
  async getCard (id) {
    ...
    if (utils.isUUID(id)) {
      return this.backend.getElementById(this.bucket, id)
    }

    return this.backend.getElementBySlug(this.bucket, id)
  }
   ...
   * await database.initialize()
   *
   * const timeline = await database.getTimeline('4a962ad9-20b5-4dd8-a707-bf819593cc84')
   *
   ...
   * await database.initialize()
   *
   * const results = await database.queryView('4a962ad9-20b5-4dd8-a707-bf819593cc84')
   *
