...
module.exports = class Kernel {
  ...
  async initialize () {
    ...
    // Built-in tables
    debug(`Creating bucket ${this.buckets.cards}`)
    await this.backend.createTable(this.buckets.cards)
  ...
  async insertCard (card, options = {}) {
    ...
    return this.backend.insertElement(this.buckets.cards, card)
  }
  ...
  async query (schema, options = {}) {
    ...
    return this.backend.querySchema(this.buckets.cards, jsonSchema.merge(filters))
  }
