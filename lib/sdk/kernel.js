...
module.exports = class Kernel {
   ...
   * await kernel.initialize()
	...
	async signup (options) {
		return this.executeInternalAction('action-create-card', 'user', {
			properties: {
				slug: `user-${options.username}`,
				data: {
					email: options.email,
					password: await credentials.hash(options.password),
					roles: []
				}
			}
		})
