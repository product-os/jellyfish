   ...
   */
	async initialize () {
		...
		for (const card of [
			...
			CARDS.core['view-read-user-default'],
			CARDS.core['view-read-user-guest'],
			CARDS.core['view-write-user-guest']
		]) {
		...
		for (const card of [
			CARDS.contrib['action-restore-card'],
			CARDS.contrib['action-delete-card'],
			CARDS.contrib['action-create-user'],
			CARDS.contrib['action-create-session'],
			CARDS.contrib['view-non-executed-action-requests'],
			CARDS.contrib['action-update-email'],
			CARDS.contrib['view-all-views'],
			CARDS.contrib.repo,
			CARDS.contrib['view-all-repos'],
			CARDS.contrib['chat-thread'],
			CARDS.contrib['chat-message'],
			CARDS.contrib['view-all-chat-messages']
		]) {
