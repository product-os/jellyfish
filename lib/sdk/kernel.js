...
module.exports = class Kernel {
   ...
   * await kernel.initialize()
   *
   * const card = kernel.getCard('4a962ad9-20b5-4dd8-a707-bf819593cc84', 'foobar')
   *
   * if (card) {
   *   console.log(card)
   * }
   ...
   * await kernel.initialize()
   *
   * const id = kernel.unsafeUpsertCard({ ... })
   * console.log(id)
   */
	async unsafeUpsertCard (card) {
		...
		return this.backend.upsertElement(this.buckets.cards, card)
	}
   ...
   * await kernel.initialize()
   *
   * const id = kernel.insertCard('4a962ad9-20b5-4dd8-a707-bf819593cc84', { ... })
   * console.log(id)
   */
