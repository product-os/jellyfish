...
export const isiOS = () => {
	...
	// If we don't have a window object, we should force a UA string so unit tests don't break
	const device = isClient ? new DetectUA() : new DetectUA('Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko')
	return device.isiOS
}
