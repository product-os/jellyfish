 ...
 * requirements for the `mixpanel-browser` package, which has the same API
 * interface
 */
...
declare module 'mixpanel-browser' {
	interface Mixpanel {
		 ...
		 */
		init(token: string, config?: Config, libraryName?: string): Mixpanel;
	...
	const mixpanelBrowser: Mixpanel;
