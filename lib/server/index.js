...
const createServer = async (options) => {
	...
	await Bluebird.each([
		...
		require('../../default-cards/contrib/action-emit-webhook.json'),
		...
		// Users
		require('../../default-cards/contrib/user-integrations.json'),

		// Roles
		require('../../default-cards/contrib/view-read-user-integrations.json'),
