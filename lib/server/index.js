...
const createServer = async (options) => {
	...
	const integrationsUser = require('../../default-cards/contrib/user-jellysync.json')
	if (process.env.INTEGRATIONS_HASH) {
		integrationsUser.data.password = {
			hash: process.env.INTEGRATIONS_HASH
		}
	}
	...
	await Bluebird.each([
		...
		// Roles
		require('../../default-cards/contrib/view-read-user-jellysync.json'),
