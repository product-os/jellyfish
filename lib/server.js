...
const createServer = () => {
	...
	return Promise.resolve(core.create({
		...
		return Promise.each([
			...
			require('../default-cards/contrib/action-create-card-from-tag.json'),
			require('../default-cards/contrib/thread.json'),
			require('../default-cards/contrib/triggered-action.json'),
			require('../default-cards/contrib/triggered-action-todo-hashtag.json'),
			...
			require('../default-cards/contrib/view-p-jellyfish.json'),
		...
		return jellyfish.insertCard(jellyfish.sessions.admin, require('../default-cards/contrib/user-guest.json'), {
			...
			return ActionRequestWorker.setup(jellyfish, jellyfish.sessions.admin, {
				...
				return new ActionRequestWorker(jellyfish, actionsSession.id)
			}).then((worker) => {
