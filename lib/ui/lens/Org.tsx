...
class Base extends React.Component<CardProps, CardState> {
	...
	public handleUserSelect = (selectedUser: CardState['selectedUser']) => {
	...
	public openUserChannel = (event: React.MouseEvent<HTMLAnchorElement>) => {
	...
	public render(): React.ReactNode {
		...
		const memberIds = _.map((card.links as any)['has member'], 'id');
