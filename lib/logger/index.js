...
module.exports.create = (name) => {
	return utils.newPrefixContext(name.toUpperCase())
}
...
module.exports.getLogger = _.memoize((filename) => {
	...
	const wrapper = new LogWrapper(winston.createLogger({
		format: combine(
	...
	wrapper.create = module.exports.create
	wrapper.context = utils
	return wrapper
})
