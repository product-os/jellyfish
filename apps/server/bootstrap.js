...
module.exports = async (context) => {
	...
	const producer = new Producer(jellyfish, jellyfish.sessions.admin, environment.rabbitmq)
	...
	const uninitializedConsumer = new Consumer(jellyfish, jellyfish.sessions.admin, environment.rabbitmq)
