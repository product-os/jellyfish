...
module.exports = ({
	...
	const defaultCards = {
		...
		viewAllSupportThreadsMyOwnedThreads: require('./balena/view-all-support-threads-my-owned-threads')(mixins),
		viewAllSupportThreadsOwned: require('./balena/view-all-support-threads-owned')(mixins),
		viewAllSupportThreadsMyPendingThreads: require('./balena/view-all-support-threads-my-pending-threads')(mixins),
		viewAllSupportThreadsPending: require('./balena/view-all-support-threads-pending')(mixins),
		viewAllSupportThreadsUnowned: require('./balena/view-all-support-threads-unowned')(mixins),
		viewAllSupportThreads: require('./balena/view-all-support-threads')(mixins),
