 ...
 */
export const generateWhisperMessage = (
	currentOwner,
	newOwner,
	reason?,
	status?,
	...
	const currentOwnerSlug = currentOwner
		? currentOwner.slug.replace('user-', '')
		: null;
 ...
 */
export const getHandoverWhisperEventCard = (
	card,
	currentOwner,
	newOwner,
	reason,
